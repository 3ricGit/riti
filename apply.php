...
<?php require './main/preloader.html';?>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="apply-now">
                <h1>Apply Here and we shall get in touch</h1>
           ...
           <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="phone" type="text" class="form-control" id="phone" placeholder="0712345678">
                </div>
           </div>
           <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="id">ID/Passport</label>
                    <input name="identity" type="text" class="form-control" id="id" placeholder="governement ID">
                </div>
                <div class="form-group col-md-6">
                    <label for="nationality">Nationality</label>
                    <input name="nationality" type="text" class="form-control" id="nationality" placeholder="i.e Kenyan">
                </div>
           </div>
           <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="firstname">Area of Specialiazation</label>
                    <input name="profession" type="text" class="form-control" id="profession" placeholder="Education">
                </div>
                <div class="form-group col-md-6">
                    <label for="certificate">Certificate</label>
                    <input name="certificate" type="text" class="form-control" id="certificate" placeholder="e.g. Diploma">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="residence" type="text" class="form-control" id="residence" placeholder="e.g Kasarani">
                </div>
                <div class="form-group col-md-6">
                    <label for="address">Address</label>
                    <input name="address" type="text" class="form-control" id="address" placeholder="3040, Nairobi">
                </div>
            </div>
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="occupation" class="form-control" id="occupations">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="designation" type="text" class="form-control" id="designation" placeholder="i.e job place">
                </div>
                <div class="form-group col-md-6">
                    <label for="tel">Tel. </label>
                    <input name="tel" type="text" class="form-control" id="tel" placeholder="i.e Tel">
                </div>
           </div>
